...
function Navbar() {
    ...
    const { avatar, isLoggedIn } = React.useContext(SearchContext)
    ...
    const signOut = ()=>{
        console.log(localStorage.getItem('token') , " From Navvvvvv.");
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline space-x-4">
                                ...
                                <Link to="/" className="rounded-md px-3 py-2 ctext-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Home</Link>
                                <Link to="/github" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Github</Link>
                                <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Calendar</a>


                                {
                                    !isLoggedIn ? <>
                                        <button className="rounded text-sm font-medium px-3 py-2 text-gray-300 hover:bg-gray-700 hover:text-white">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-4 flex items-center md:ml-6">
                            ...
                            <div className="relative ml-3">
                                <div>
                                    <button type="button" className="profile-icon relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true"
                                        onClick={handleShow}
                                    >
                                        <span className="absolute -inset-1.5"></span>
                    ...
                    <div className="-mr-2 flex md:hidden">
                        ...
                        {/* <button><link>SignUp</link></button> */}
                    </div>
                </div>
            </div>
